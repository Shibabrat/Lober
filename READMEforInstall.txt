Lober: Computational engine for lobe dynamics
%=======================================%
Installing and troubleshooting 
Lober 1.8 on Mac OS X with XCode
Authors: Francois Lekien, Shane Ross, Shibabrat Naik
%=======================================%

INSTALLATION
	Follow instructions in the INSTALL-CDS-CLUSTER.txt and INSTALL.txt
